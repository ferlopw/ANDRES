...
class GenerateSignalsView(BaseView):
    ...
    def display(self):
        ...
        print("Agregando menú, contenido completo y tabla a la página")
        self.page.controls.clear()
        self.page.add(main_content)
        self.page.update()
        print("Menú, contenido completo y tabla agregados y página actualizada")
